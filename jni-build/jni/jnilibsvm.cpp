...
extern "C" void Java_ch_zhaw_facerecognition_Recognition_SupportVectorMachine_jniSvmTrain(JNIEnv *env, jobject obj, jstring cmdIn){
...
extern "C" void Java_ch_zhaw_facerecognition_Recognition_SupportVectorMachine_jniSvmPredict(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
...
*/
extern "C" JNIEXPORT int JNICALL Java_ch_zhaw_facerecognition_Recognition_SupportVectorMachine_testInt(JNIEnv * env, jobject obj){
	return 5566;
}

extern "C" void Java_ch_zhaw_facerecognition_Recognition_SupportVectorMachine_testLog(JNIEnv *env, jobject obj, jstring logThis){
