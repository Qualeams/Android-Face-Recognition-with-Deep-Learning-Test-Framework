...
package ch.zhaw.facerecognition.PreProcessor;
...
import ch.zhaw.facerecognition.Helpers.Eyes;
import ch.zhaw.facerecognition.Helpers.FaceDetection;
import ch.zhaw.facerecognition.PreProcessor.BrightnessCorrection.GammaCorrection;
import ch.zhaw.facerecognition.PreProcessor.Contours.DifferenceOfGaussian;
import ch.zhaw.facerecognition.PreProcessor.Contours.LocalBinaryPattern;
import ch.zhaw.facerecognition.PreProcessor.Contours.Masking;
import ch.zhaw.facerecognition.PreProcessor.ContrastAdjustment.HistogrammEqualization;
import ch.zhaw.facerecognition.PreProcessor.StandardPostprocessing.Resize;
import ch.zhaw.facerecognition.PreProcessor.StandardPreprocessing.Crop;
import ch.zhaw.facerecognition.PreProcessor.StandardPreprocessing.EyeAlignment;
import ch.zhaw.facerecognition.PreProcessor.StandardPreprocessing.GrayScale;
