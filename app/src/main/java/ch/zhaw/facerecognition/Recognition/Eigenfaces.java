...
import ch.zhaw.facerecognition.Helpers.OneToOneMap;
...
public class Eigenfaces implements Recognition {
    ...
    public String recognize(Mat img, String expectedLabel){
        ...
        // Project to subspace
        Mat projected = projectToSubspace(img);
    ...
    private Mat projectToSubspace(Mat original){
